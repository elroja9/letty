...
public class FrmUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnBorrarUsuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/borrar.png"))); // NOI18N
        ...
        tblUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cedula", "Nombre", "Apellido", "Tel", "Clave", "Puesto"
            }
        ));
    ...
    private void btnModificarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarUsuarioActionPerformed
        ...
        if (fila == -1) {
            ...
            MantUsuario.txtCedula.setText(tblUsuarios.getValueAt(fila, 0).toString());
            MantUsuario.txtNombre.setText(tblUsuarios.getValueAt(fila, 1).toString());
            MantUsuario.txtApellido.setText(tblUsuarios.getValueAt(fila, 2).toString());
            MantUsuario.txtTel.setText(tblUsuarios.getValueAt(fila, 3).toString());
            MantUsuario.txtClave.setText(tblUsuarios.getValueAt(fila, 4).toString());
            MantUsuario.txtCedula.setEditable(false);
            mantUsuario.setVisible(true);
            mantUsuario.setLocation(500, 100);
        }
    ...
    private void btnBorrarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarUsuarioActionPerformed
        ...
        if(fila==-1)
        {
            ...
            int resp = JOptionPane.showConfirmDialog(rootPane, "Esta segur@ de eliminar la información de "
                    + tblUsuarios.getValueAt(fila, 0), this.getTitle(), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if(resp==JOptionPane.YES_OPTION){
            try {
                usuario.setCedula(tblUsuarios.getValueAt(fila, 0).toString());
                BDUsuario.eliminarUsuario(usuario);
            } catch (SQLException ex) {
                Logger.getLogger(FrmUsuario.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            JOptionPane.showMessageDialog(rootPane,"Se eliminó con exito el usuario","Eliminación con éxito",JOptionPane.PLAIN_MESSAGE);
            mostrarUsuario();
        }
    ...
    private void btnNuevoUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoUsuarioActionPerformed
        mantUsuario.nuevo=true;
        mantUsuario.setVisible(true);
        mantUsuario.setLocation(500,100);
        MantUsuario.txtCedula.setEditable(true);
        MantUsuario.txtCedula.setText("");
        MantUsuario.txtNombre.setText("");
        MantUsuario.txtApellido.setText("");
        MantUsuario.txtTel.setText("");
        MantUsuario.txtClave.setText("");
        nuevo=true;
    ...
    public void mostrarUsuario(){
        ...
        try{
            ...
            ResultSet rs=stm.executeQuery("select * from vis_usuarios");
