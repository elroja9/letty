    ...
    private void tblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClientesMouseClicked
        // TODO add your handling code here:
           ...
           int fila = tblClientes.getSelectedRow();
            ...
            String credito=tblClientes.getValueAt(fila, 4).toString();
            FrmFactura.lblCedCliente.setText(ced);
            FrmFactura.lblCedCliente.setVisible(false);
            FrmFactura.txtCliente.setText(nombre+" "+apellido);
            FrmFactura.lblCredito.setText(credito);
            JOptionPane.showMessageDialog(rootPane," el cliente fue agregado correctamente");
            JOptionPane.showMessageDialog(rootPane,tblClientes.getValueAt(fila, 4).toString());
            cerrar();
           }
           }
           }
